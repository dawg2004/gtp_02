...
export function EventCard({ event }: { event: EventItem }) {
  return (
    <article className="group border border-stone-200 bg-white transition hover:-translate-y-1 hover:shadow-sm">
      <Link href={`/events/${event.slug}`} className="block">
        ...
        <div className="p-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <span aria-label="Bookmark" className="text-lg text-stone-500">◇</span>
          </div>
